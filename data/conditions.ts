export const Conditions: {[k: string]: ConditionData} = {
	...
	slp: {
        ...
        onBeforeMove(pokemon, target, move) {
                ...
                if (!pokemon.statusState.isRest && pokemon.statusState.time === 2 && this.randomChance(1, 3)) {
                        pokemon.cureStatus();
                        return;
                }
                pokemon.statusState.time--;
	...
	frz: {
        ...
        onBeforeMove(pokemon, target, move) {
                ...
                pokemon.statusState.time++;
                if (pokemon.statusState.time >= 4 || (pokemon.statusState.time === 3 && this.randomChance(1, 4))) {
                        pokemon.cureStatus();
                        return;
                }
